...
class GRPOConfig(TrainingArguments):
    ...
    # DASH (ours)
    reward_iw: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to use reward importance weighting."},
    )
    iw_clip: Optional[float] = field(
        default=2.0,
        metadata={"help": "Clipping value for reward importance weights."},
    )
